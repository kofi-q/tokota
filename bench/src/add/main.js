...
mitata.summary(() => {
  mitata.bench("c", () => c.add(2.3, 5.2));
  mitata.bench("cpp (node-addon-api)", () => cpp.add(2.3, 5.2));
  mitata.bench("zig (tokota - ffi)", () => zig_ffi.add(2.3, 5.2));
  mitata.bench("zig (tokota)", () => zig.add(2.3, 5.2));
});
